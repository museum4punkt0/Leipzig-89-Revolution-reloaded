...
Für Nutzung der Webanwendung im Ausstellungsraum wurden an mehrern Stellen QR-Codes angebracht. Durch scannen des QR-Codes können die Besucher*innen ihre Anwesenheit im Museum verifizieren und dierekt auf die Web-URL zugreifen. Das scannen der QR-Codes funktioniert nur wenn die Anwendung auf einer "https"-URL läuft.
